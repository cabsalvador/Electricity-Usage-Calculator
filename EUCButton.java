...
public abstract class EUCButton extends JButton implements ActionListener{
	...
	public void goToSelectUserPage(){
		electricityUsageCalculator.showSelectUserPage();
	}
	
	public void goToCreateNewUserPage(){
		electricityUsageCalculator.showCreateNewUserPage();
	}
	
	public void goToMainPage(){
		electricityUsageCalculator.showMainPage();
	}
}